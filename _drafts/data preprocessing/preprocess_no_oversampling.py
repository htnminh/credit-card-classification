...
# Write to files
X_train.to_csv(os.path.join(ABS_PATH, 'X_train_prep_noover.csv'), index=False)
pd.DataFrame(y_train).to_csv(os.path.join(ABS_PATH, 'y_train_prep_noover.csv'), index=False)
X_test.to_csv(os.path.join(ABS_PATH, 'X_test_prep_noover.csv'), index=False)
pd.DataFrame(y_test).to_csv(os.path.join(ABS_PATH, 'y_test_prep_noover.csv'), index=False)
